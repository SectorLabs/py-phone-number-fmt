...
from phonenumberfmt import format_phone_number_list
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("+40773818041/+97172273000", ["+40773818041", "+97172273000"]),
        ("+40773818041 / +97172273000", ["+40773818041", "+97172273000"]),
        ("+971-50-1896203", ["+971501896203"]),
        ("+971(0)508882395", ["+971508882395"]),
        (
            "+971-50-1003023 / +971-558683397",
            ["+971501003023", "+971558683397"],
        ),
        ("971-50-1896203", ["+971501896203"]),
        ("+92 321 9224895", ["+923219224895", "+9224895"]),
        (
            "+971-50-2516838, +971- 55-4396334/ 693436544",
            ["+971502516838", "+971554396334", "PREFIX693436544"],
        ),
        ("////////+40773818041", ["+40773818041"]),
        ...
        ("+97144220125#40,+971503292710#40", ["+97144220125", "+971503292710"]),
        ("+97144220125:40,+971503292710:40", ["+97144220125", "+971503292710"]),
        ("+92-3002125421 +92-312-8222973", ["+923002125421", "+923128222973"]),
    ],
)
def test_format_phone_number(phone_region, input, output):
    data = format_phone_number_list(input, implied_phone_region=phone_region)
    localized_output = list(
        (
            output_el.replace("PREFIX", dialing_prefix_for_region(phone_region))
            for output_el in output
        )
    )
    assert data is not None
    assert localized_output == data
